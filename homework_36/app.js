...
// function genres() {
//     let array = [...data];
//     let allGenres = array.reduce((a, b) => {
//       return [...a, ...b.genre];
//     }, []);
//     let filteredGenres = allGenres.filter(
//       (element, index) => allGenres.indexOf(element) === index
//     );
...
//     let array = [...data];
//     let allActors = array.reduce((a, b) => {
//             return [...a, ...b.actors];
//           }, []);
//     let filteredActors = allActors.filter(
//       (element, index) => allActors.indexOf(element) === index
//     );
...
//     let myArray = [...data];
//     myArray.sort((a, b) => b.imdbRating - a.imdbRating);
//     return myArray;
//   }
  
//   console.log(sortRating(data));
...
//       let released = { released: element.released };
//       let plot = { plot: element.plot };
//       return Object.assign(id, title, released, plot);
//     });
//     return newArray;
//   }
...
//  function movieNumber(released, year) {
//     let array = [...released];
//     let filteredMovies = array.filter((element) =>
//       element.year === year ? element : null
//     );
//     return filteredMovies;
//   }
  
//   console.log(movieNumber(data, 2009));
